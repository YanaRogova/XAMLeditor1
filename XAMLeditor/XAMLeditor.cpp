...
// XAMLeditor.cpp: определяет поведение классов для приложения.
//
...
// Единственный объект CXAMLeditorApp

CXAMLeditorApp theApp;


// Инициализация CXAMLeditorApp
...
// Обработчики сообщений CXAMLeditorApp
